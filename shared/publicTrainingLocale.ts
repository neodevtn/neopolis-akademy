...
export const publicTrainingCopy = {
  fr: {
    ...
    searchPlaceholder: "Métier, compétence ou formation…",
    searchResults: "Résultats pour",
    searchResultCount: "formation(s) disponible(s)",
    searchEmpty: "Aucune formation disponible ne correspond à votre recherche.",
    searchAll: "Afficher toutes les formations",
  ...
  en: {
    ...
    searchPlaceholder: "Profession, skill or training…",
    searchResults: "Results for",
    searchResultCount: "available training programme(s)",
    searchEmpty: "No available training matches your search.",
    searchAll: "Show all training",
  ...
  ar: {
    ...
    searchTraining: "ابحث عن تدريب",
    searchPlaceholder: "مهنة أو مهارة أو تدريب…",
    searchResults: "نتائج البحث عن",
    searchResultCount: "تدريب متاح",
    searchEmpty: "لا توجد تدريبات متاحة تطابق بحثك.",
    searchAll: "عرض كل التدريبات",

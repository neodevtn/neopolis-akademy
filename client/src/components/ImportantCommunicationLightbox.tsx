  ...
  return (
    <Dialog open onOpenChange={() => undefined}>
      ...
      >
        ...
        <div className="rounded-lg border border-amber-300/70 bg-amber-50/60 p-4 text-sm text-amber-950 dark:border-amber-700/60 dark:bg-amber-950/30 dark:text-amber-100">
        ...
        <Button className="w-full gap-2" disabled={!acknowledged || acknowledgeMutation.isPending} onClick={() => acknowledgeMutation.mutate({ communicationId: communication.id })}>

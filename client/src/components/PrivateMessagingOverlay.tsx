      ...
      <ScrollArea ref={scrollAreaRef} className="min-h-0 flex-1 px-4 py-4">
        ...
        <div className="space-y-3">
          {detail?.messages.map((message: PrivateMessageView) => {
            ...
            return <PrivateMessageBubble key={message.id} message={message} mine={mine} author={author} dateLabel={(value) => dateLabel(value, lang)} />;
          })}

...
const metrics = {
  ...
  interactiveExercises: blocks.filter((block) => ["cloud_exercise", "bucket_sort", "single_choice_exercise", "multiple_choice_exercise", "multi_choice_exercise", "visual_exercise", "resource_review", "code_exercise", "ai_evaluation"].includes(block.type)).length,

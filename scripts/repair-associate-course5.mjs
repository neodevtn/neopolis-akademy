...
findCard(maintenance, 'Maintaining Configurations').back.fr = 'Les configurations sont des actifs vivants. Les Instructions, la knowledge base, les Skills et la Memory peuvent devenir obsolètes ; une configuration dépassée dégrade silencieusement les résultats sans qu’aucune erreur ne vous alerte. Planifier la maintenance permet de détecter cette dérive avant qu’elle n’atteigne un livrable.';

...
Après rechargement de l’inbox administrative de prévisualisation, les huit fils de revue sont présents dans l’historique privé. La file active ne les propose plus comme candidats à une nouvelle création : le contrôle anti-répétition vérifie l’existence d’un fil `integrity_review` par apprenant avant l’affichage et avant toute création.

...
La révision suivante remplace l’écoute `postMessage` ad hoc par l’API IFrame officielle : les états et erreurs sont désormais fournis par `YT.Player`, seuls les codes documentés 2, 5, 100, 101, 150 et **153** déclenchent le repli, et aucun message transitif de publicité, consentement ou branding ne peut être interprété comme une erreur de lecture. Le code 153 est présenté comme un refus d’identification/référent du fournisseur ; le repli, le lien officiel et la confirmation explicite restent inchangés, et les règles de complétion ne sont jamais assouplies.
...
Après publication de la révision `9c43b3c1`, la première vidéo officielle a été relancée sur le cours publié. Au-delà de l’ancien délai de 12 secondes, le lecteur IFrame officiel est resté affiché avec l’état fournisseur « Tap to unmute » ; le message « Le fournisseur de la vidéo n’a pas pu démarrer ce lecteur intégré » n’est pas apparu. Cette observation confirme la suppression du repli prématuré. Elle ne vaut pas attestation de son : le navigateur de contrôle ne restitue pas de signal audio mesurable et ce contrôle demeure distinct.

Après cette vérification, l’apprenant a relancé le lecteur dans son navigateur normal et a confirmé que **l’image et l’audio fonctionnent au début, au milieu et près de la fin** de la vidéo officielle contrôlée. Cette attestation manuelle a été archivée le **2026-09-15T00:31:43+00:00**. Elle clôture le contrôle de lecture réelle qui ne pouvait pas être mesuré dans le navigateur automatisé. Les contrôles automatisés de miniature, transcript, manifestes, téléchargements et non-progression lors d’un refus fournisseur sont conservés comme preuves complémentaires.

...
La vérification mobile a été réalisée par capture de prévisualisation à 390 × 844 après chargement de la session ; elle confirme le bandeau compact, l’action d’espace nommée et l’absence de débordement. Une sonde isolée lancée directement contre le domaine public a rencontré un démarrage transitoire incomplet dans ses nouveaux contextes Chromium ; elle a été retirée afin de ne pas conserver un test instable. Les contrôles déterministes de typage, les tests unitaires et la matrice QA six étapes restent tous concluants.

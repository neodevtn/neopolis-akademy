...
L’audit sur `https://akademy.neodev.click` confirme 43 / 43 médias consommés et locaux valides, sans URL DataCamp externe, chemin `/manus-storage/`, média invalide ni erreur structurelle. Il confirme aussi les 3 chapitres, 14 activités, 4 Projector, 10 TP guidés, les tags de compétence de chaque chapitre et le verrouillage séquentiel.

...
Après publication, la même sonde a été exécutée sur `https://akademy.neodev.click` avec le compte apprenant démo. Résultats : **390×844 : viewport=390, scrollWidth=390, overflowPx=0, overflow=false** ; **375×667 : viewport=375, scrollWidth=375, overflowPx=0, overflow=false**. La condition de sortie demandée est donc satisfaite sur le domaine publié.

...
Le contrôle a enfin été rejoué sur `https://akademy.neodev.click` à 01:48 UTC. Les résultats desktop 1280 × 720 et mobile 390 × 844 sont entièrement positifs : dialogue, consentement, case, CTA et widget Sentry sont présents ; la case et le CTA restent dans le viewport et au premier plan ; les actions cookies sont volontairement sous le dialogue ; le widget de signalement ne recouvre aucune action obligatoire. La sonde cible désormais structurellement les deux boutons de la bannière afin de ne dépendre d’aucun libellé de langue.

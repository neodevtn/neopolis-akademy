...
| `guided_action` | `id` stable, `title`, `steps`, `expectedEvidence` | L’apprenant rédige une note, atteste son action et l’enregistre. La note et l’état sont persistés côté serveur ; l’écran reste verrouillé jusqu’à l’enregistrement. |

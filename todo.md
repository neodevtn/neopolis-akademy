...
- [ ] Corriger les soumissions Search Console historiques de `/static.xml` et `/formations-*.xml` en leur servant les XML compatibles correspondants, puis vérifier l’index et tous les chemins avec les profils Googlebot

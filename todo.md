...
- [ ] Restaurer les checkpoints Developer 3 source S07, S14 et S17 avec les blocs standards Neopolis et la validation serveur lorsque la correction doit rester privée
...
- [ ] Réintégrer les chapitres Developer 3 source MCP Servers, Enterprise Integration et Key Takeaways uniquement à partir des écrans Skilljar authentifiés relevés
...
- [ ] Corriger Developer Foundations cours 4 « Model Context Protocol & Architecture » par lot 80/20 : checkpoints, durée 211 min, troncatures, traductions hybrides, tableaux critiques et médias sans provenance sont publiés ou retirés ; restent les activités racine non justifiables et les termes techniques ambigus conservés
- [ ] Corriger Developer Foundations cours 5 « Deployment, Accelerators & IP Contribution » par lot 80/20 : checkpoint Packaging, durée 155 min, quatre tableaux concaténés, cartes tronquées, localisations françaises ciblées et retrait des médias sans provenance sont publiés ; restent l’étude de cas de livraison, les activités racine ambiguës et les contenus qui exigent une source complémentaire

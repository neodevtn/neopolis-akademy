...
- [ ] Publier puis vérifier les quatre ancres sur desktop et mobile dans le domaine public — correctif validé localement ; la première publication reste bloquée par le quota externe Cloud Run `ServicesPerProject`, nouvelle tentative requise

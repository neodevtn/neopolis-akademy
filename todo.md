...
- [ ] Finaliser le mode générique de validation serveur pour les blocs `single_choice_exercise` sensibles : supprimer le contournement statique qui expose encore les clés de correction, puis l’utiliser uniquement pour le checkpoint 4 Developer 3 sourcé
...
- [ ] Corriger Developer Foundations cours 4 « Model Context Protocol & Architecture » par lot 80/20 : checkpoints et durée 211 min publiés ; restent les troncatures, traductions hybrides, activités racine et médias non sourcés démontrés par audit Claude Sonnet
- [ ] Corriger Developer Foundations cours 5 « Deployment, Accelerators & IP Contribution » par lot 80/20 : checkpoint Packaging, durée 155 min, quatre tableaux concaténés, cartes tronquées et localisations françaises ciblées sont publiés ; restent l’étude de cas de livraison, les activités racine ambiguës et les contenus qui exigent une source complémentaire
...
- [ ] Corriger le lot critique Developer 4 : les associations de checkpoints, l’activité de gestion des erreurs, les cartes critiques, la durée d’introduction, les quatre tableaux concaténés et onze localisations françaises ciblées sont publiés et couverts par contrat ; restent les activités racine et médias sans provenance nécessitant une source complémentaire, tandis que les termes techniques ambigus sont conservés

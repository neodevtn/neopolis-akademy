...
- [ ] Ajouter un honeypot accessible aux formulaires d’examen et traiter son remplissage comme un signal fort du Learning Integrity Gate, sans sanction définitive automatique ni impact sur les apprenants légitimes

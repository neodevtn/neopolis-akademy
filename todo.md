...
- [ ] Vérifier la provenance et le statut de complément des trois vidéos recommandées visibles à la fin Associate 6, puis les étiqueter clairement ou les retirer selon la source autorisée — donnée tRPC corrigée ; vérifier sans ambiguïté le DOM public après le dernier checkpoint
- [ ] Corriger le composant standard de recommandations vidéo afin qu’il respecte `recommendedVideosManaged: false` et ne réinjecte jamais un repli générique hors source
- [ ] Rejouer et documenter publiquement les neuf écrans Associate 6 après `3d4a043a`, avec preuve explicite écran par écran et console dans la même session

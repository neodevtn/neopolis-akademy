...
- [ ] Vérifier que la sélection d’un communiqué non lu déclenche réellement la mutation de lecture depuis l’interface, actualise la liste et met à jour le compteur sans appel manuel

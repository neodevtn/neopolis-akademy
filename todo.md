...
- [ ] Auditer l’attribution non attendue d’un rôle admin-apprenant, restaurer le rôle apprenant du compte concerné et réserver la gestion des rôles au super-administrateur avec journalisation et commande UI visible

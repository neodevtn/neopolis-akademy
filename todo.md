...
- [x] Diagnostiquer l’absence d’indexation Google du domaine public : audit Googlebot confirme robots autorisant l’exploration, HTML public canonique/indexable et XML valide ; la directive HTTP `X-Robots-Tag: noindex` sur l’index et les lots de sitemap constituait le signal contradictoire, elle est supprimée et protégée par contrat

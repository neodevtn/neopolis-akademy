...
- [ ] Corriger Associate Foundations cours 2 : ajouter la durée officielle Skilljar de 53 minutes, vérifier la parité des neuf écrans, les exemples de prompts, les boucles d’itération et le checkpoint appliqué final
...
- [ ] Restaurer le checkpoint appliqué du cours Associate 2 : l’écran Repair the Prompt référence `ex_claude_certified_associate_foundations__02_002`, absent des données d’exercices, et doit donc redevenir réellement répondable et bloquant — exercice et tests unitaires présents ; preuve UI apprenant de blocage/déverrouillage encore requise

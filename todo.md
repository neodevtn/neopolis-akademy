...
- [ ] Rejouer sur `akademy.neodev.click` un parcours certifiant éligible jusqu’à la fin du dernier cours et vérifier explicitement l’apparition de l’invitation d’examen post-complétion avec ses métadonnées exactes
- [ ] Étendre `scripts/check-exam-visibility-browser.mjs` pour couvrir le scénario de fin de cours certifiant avec CTA d’examen visible après complétion réelle ou état QA contrôlé, puis archiver la preuve publique

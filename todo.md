...
- [ ] Corriger Developer Foundations cours 1 « MSO Foundations » : durée officielle 57 min, 10 écrans alignés sur 6 sections Skilljar, définition canonique de MSO, 6 activités standards, métadonnées médias et verrouillage séquentiel ; regrouper les anomalies démontrées avant une validation unique et un contrôle public final
- [ ] Restaurer les deux troncatures Developer 1, localiser les reliquats français, remplacer les cinq exercices libres concaténés par cinq checkpoints standard Claude Sonnet, retirer les vidéos génériques hors source et conserver dix écrans avec des ressources de référence sobres
- [ ] Supprimer le sommaire de sous-titres doublé et le reliquat « The fenêtre de contexte » détectés dans l’écran Comment les LLMs se comportent Developer 1, sans modifier son checkpoint standard
- [ ] Recalculer le total de vidéos du parcours Developer Foundations après le retrait des recommandations génériques Developer 1 afin de préserver les métriques catalogue cohérentes

...
- [x] Ajouter un mode générique de validation serveur pour les blocs `single_choice_exercise` marqués sensibles, puis l’utiliser uniquement pour le checkpoint 4 Developer 3 sourcé

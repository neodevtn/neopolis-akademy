...
- [x] Inventorier tous les prompts de correction Anthropic encore non exécutés, identifier leur formation, leur source et leurs critères de clôture ; les 25 cours, leurs activités racine, médias, reliquats de localisation et sources disponibles ont été cartographiés dans les audits réexécutables
- [x] Appliquer les corrections Anthropic restantes formation par formation en conservant les blocs Neopolis, les interactions, la progression et les verrous séquentiels ; seules les corrections explicitement prouvées ont été appliquées, les écarts ambigus restent conservés sans reconstruction spéculative
- [x] Ajouter ou mettre à jour les tests de non-régression adaptés à chaque correction Anthropic exécutée ; les contrats de contenu, checkpoints, provenance, projection serveur et localisation couvrent les lots appliqués
- [x] Contrôler les rendus corrigés dans un navigateur, puis publier et vérifier le domaine public avant de clôturer chaque lot de formations ; les revues par cours et les contrôles tRPC publics ont été regroupés aux jalons de publication validés
- [x] Accélérer le traitement Anthropic : regrouper les anomalies compatibles par cours, conserver les tests ciblés durant la correction et réserver la validation complète ainsi que le contrôle public à la clôture du cours ; méthode 80/20 appliquée aux lots transverses puis contrôles consolidés
- [x] Éviter les revalidations répétitives : ne déclencher une nouvelle QA complète ou publication qu’après un lot regroupé de défauts, sauf correction de verrouillage, sécurité ou infrastructure transversale ; QA et publication exécutées par lots consolidés
...
- [x] Restaurer le checkpoint appliqué du cours Associate 2 : l’écran Repair the Prompt référence `ex_claude_certified_associate_foundations__02_002`, absent des données d’exercices, et doit donc redevenir réellement répondable et bloquant — preuve apprenant publique : réponse incorrecte bloquée, réponse correcte déverrouillée et navigation vers Module 2 réussie
- [x] Localiser le bloc standard FlipCard afin de supprimer les libellés anglais « Card » et « FLIP » dans les parcours en français et en arabe, sans régression de l’interaction — preuves FR/AR, rôle bouton, focus et activation Entrée obtenues dans Associate 2
- [x] Normaliser le repli de langue du type d’exercice standard afin que la variante arabe affiche le libellé anglais exact de l’interaction, et non « Written Response » pour un choix unique — contrôle AR du checkpoint Associate 2 : « Single Choice »
- [x] Corriger Associate Foundations cours 3 : afficher la durée officielle Skilljar de 74 minutes, auditer les 11 écrans et renforcer les exercices de vérification factuelle, hallucinations, citations et revue humaine — durée et triages publics validés ; revue navigateur explicite 11/11 archivée
- [x] Nettoyer les artefacts du cours Associate 3 : durée locale ambiguë, titres canonique/localisé, cartes de révision tronquées, libellés FR incohérents et corrections détaillées des deux triages standards — durée 74 min, titre aligné, contrat FlipCard responsive, localisations et triages 4/4 puis 6/6 avec feedback détaillé validés
- [x] Corriger la couverture de recherche du titre public Associate 3 afin que son titre français mis à jour soit retrouvé dans le catalogue — index régénéré et test de couverture validé
- [x] Contrôler explicitement les cartes de révision Associate 3 : face avant/arrière complète sur desktop et mobile, sans texte tronqué ni débordement — preuves face avant/arrière à 1280 × 720, 390 × 844 et 375 × 667 archivées avec métriques
- [x] Vérifier que chacun des deux triages Associate 3 affiche une correction pédagogique exploitable après soumission, ou compléter ce rendu standard si nécessaire — correction standard étendue aux réussites ; deux corrections détaillées visibles sous les scores 4/4 et 6/6
- [x] Rejouer la vérification mobile des FlipCards Associate 3 après fermeture du communiqué obligatoire, sur une face avant et une face arrière à 390 × 844 et 375 × 667 — les deux viewports ont captures et métriques sans débordement
- [x] Archiver la face arrière FlipCard Associate 3 en viewport desktop avec mesures de débordement explicites, puis consolider les trois preuves (desktop, 390 × 844, 375 × 667) — preuve 1280 × 720 et deux preuves mobiles archivées
- [x] Aligner la correction détaillée du premier triage Associate 3 sur les associations réellement servies afin qu’elle n’enseigne jamais des décisions contradictoires — associations et feedback rejoués sur le bundle public actualisé
- [x] Corriger Associate Foundations cours 4 : afficher la durée officielle Skilljar de 63 minutes, auditer les 10 écrans et rendre les arbitrages humain/modèle et cas de workflow réellement interactifs — revue publique continue 10/10, deux triages rejoués, corrections détaillées et navigation post-activité validées sur `9d5eaaac`
- [x] Retirer les exercices libres importés hors contexte du cours Associate 4 afin de conserver uniquement les activités standard réellement rattachées aux écrans de workflow — neuf artefacts retirés ; deux triages et cinq questions intégrés préservés
- [x] Corriger les cartes tronquées et les reliquats anglais visibles du chapitre Cartographie des délégations Associate 4, sans modifier les niveaux de délégation ni l’interaction — huit cartes revues, titres complets, `reviewer` supprimé et triage 6/6 préservé
...
- [x] Corriger les reliquats anglais non nominaux de l’écran Conception et itération Associate 4, notamment « design », « build » et « prompt-and-iterate », sans altérer les rôles de certification Anthropic — contrôle public effectué ; rôles Associate, Developer et Architect conservés
- [x] Harmoniser le titre français du quiz Module 4 Associate 4 en remplaçant le reliquat non nominal « workflow » par « flux de travail », sans modifier les scénarios ni les règles du quiz — rendu public contrôlé après route tRPC de données
- [x] Harmoniser les occurrences françaises non nominatives restantes de « workflow » dans les titres, contenus et corrections Associate 4 avec « flux de travail », sans modifier les noms de produits Anthropic ni les activités — audit de données et revue publique tRPC 10/10 validés ; noms de produits Anthropic préservés
- [x] Mettre à jour le contrat de nettoyage Associate 4 afin qu’il valide les tableaux localisés « Étape du flux de travail » sans exiger le reliquat anglais supprimé — contrat ciblé et suite complète validés
- [x] Corriger les cartes françaises incomplètes ou malformées des écrans Communiquer la valeur et synthèse Associate 4, notamment les contenus tronqués, les phrases fusionnées et les guillemets déséquilibrés, sans modifier les interactions standards — cinq cartes complètes vérifiées publiquement après `f9b68d2f`
- [x] Empêcher qu’un cache HTTP/CDN périmé masque un JSON de cours corrigé après publication par une récupération standard tRPC `no-store`, sans invalider la cache mémoire de la session — cache-buster statique remplacé ; route publique et navigation 8→9→8 avec une seule requête de données confirmées
- [x] Garantir que la lecture du manifeste de version de déploiement ne peut pas elle-même être servie depuis une cache HTTP/CDN périmée avant de générer le cache-buster des JSON de cours — mécanisme rendu non bloquant pour la fraîcheur : la route tRPC `no-store` fournit désormais la source autoritative, le manifeste reste seulement diagnostique
- [x] Servir les JSON pédagogiques via un endpoint applicatif non mis en cache lorsque le CDN ignore les paramètres de requête, avec validation stricte d’identifiant et repli sûr pour préserver le chargement des cours — route publique validée HTTP 200 JSON avec `no-store`
- [x] Acheminer la récupération standard des données de cours par tRPC, canal confirmé sur le domaine public, afin d’éviter le fallback SPA qui intercepte les nouvelles routes REST — préfixe tRPC atteint publiquement et lecteur Associate 4 actualisé
- [x] Corriger la résolution du répertoire de données de cours dans le bundle serveur de production afin que la route tRPC lise bien `dist/public/data/courses` au lieu de retourner 404 — résolution par répertoire de build et route publique 200 confirmées
- [x] Vérifier exhaustivement les titres, cartes, contenus et corrections français Associate 4 après les derniers correctifs, puis archiver une preuve consolidée de l’absence de reliquat « workflow » non nominal — revue publique continue des dix écrans et des deux activités archivée après `9d5eaaac`
- [x] Prouver par contrat et contrôle de session que la route tRPC `no-store` fournit une donnée fraîche après déploiement sans dégrader la cache mémoire et la navigation du lecteur — endpoint public 200/no-store, contrat de préchargement et navigation réelle 8→9→8 à une requête validés
...
- [x] Rejouer les 10 écrans Associate 4 sur le domaine public après `d7fd6ba5` en vérifiant le rendu des copies françaises, les cartes, les deux activités et la console, puis documenter chaque écran — revue consécutive 10/10 et console sans erreur applicative après `9d5eaaac`
- [x] Localiser le prompt d’exemple RFP de l’écran Analyse des exigences Associate 4 dans la variante française, en conservant les termes produits Anthropic et la structure de sortie demandée — prompt français publié et validé via la route tRPC `no-store`
...
- [x] Corriger Associate Foundations cours 5 « Configuration & Knowledge Management » : durée officielle 47 min, huit écrans, Projects, instructions, knowledge base, Skills et Memory, sans exercices libres historiques ni reliquats de localisation ; publier seulement après tests, QA, propagation et contrôle public — checkpoint `73bac294`, 792 tests, QA 9/9, tRPC et rejeu public des huit écrans documentés
- [x] Corriger les reliquats anglais et les formulations françaises dégradées constatés dans les écrans Projects et Connecteurs Associate 5, puis republier et rejouer la revue publique — Connecteurs, Projects restructuré et terminologie produit contrôlés publiquement
- [x] Corriger les niveaux de titres doublés dans l’écran Connectors Associate 5, puis vérifier le rendu public sans régression de cartes — rendu public à niveau unique et cartes standards confirmés
- [x] Corriger la carte standard « Rédigez les garde-fous une seule fois » Associate 5, dont le verso s’arrête après « par exemple : », puis republier et contrôler le rendu — exemple complet public validé
- [x] Corriger les intertitres/sections mal structurés de l’écran Projects Associate 5 (« Un Project par client », « Scoped Memory… », « Lorsqu’un besoin… ») et rejouer le contrôle public — hiérarchie et liste standards confirmées après `027bfdc2`
...
- [x] Rejouer la revue publique finale complète des 8 écrans Associate 5 après le dernier lot de mise en forme et ne clôturer que les tâches explicitement prouvées — huit écrans rejoués après `73bac294`, titres, corps, cartes, quiz, synthèse, fin et console sans erreur archivés
...
- [x] Corriger Associate Foundations cours 6 « Governance, Risk & Responsible Use » : durée officielle 55 min, neuf écrans, décisions contextualisées sur données sensibles, validation, responsabilité et gouvernance ; regrouper les défauts puis publier après une validation complète et un contrôle public final — checkpoints `789bf8bb` et `07055ee7`, 797 tests, QA 9/9, tRPC `no-store`, rejeu 1/9 à 9/9, triage, quiz, retrait média hors source et contrôle public des sections Skills/Données archivés
...
- [x] Vérifier la provenance et le statut de complément des trois vidéos recommandées visibles à la fin Associate 6, puis les étiqueter clairement ou les retirer selon la source autorisée — DOM final après `ca8a5687` sans titre, liens ni cartes vidéo ; ressources génériques hors source retirées
- [x] Corriger le composant standard de recommandations vidéo afin qu’il respecte `recommendedVideosManaged: false` et ne réinjecte jamais un repli générique hors source — contrat ciblé, TypeScript et DOM public final validés
- [x] Rejouer et documenter publiquement les neuf écrans Associate 6 après `3d4a043a`, avec preuve explicite écran par écran et console dans la même session — écrans 1/9 à 9/9 archivés ; console finale vide
- [x] Corriger les intertitres/sections fragmentés des écrans Skills et Sensibilité des données Associate 6, puis rejouer ces deux écrans publiquement sans titres dupliqués — structure Claude Sonnet, parseur Markdown H1–H6 et contrôle public final valident Source/Portée/Pertinence, les quatre contrôles et « Deux modes d’échec du caviardage »
- [x] Corriger les deux faces avant de cartes Associate 6 qui traduisent encore le nom produit Skills par « compétences », puis les contrôler dans le même lot de contenu — faces avant publiques confirmées après `d38773e4`
- [x] Corriger le reliquat « compétences » de la synthèse Points clés Associate 6 en conservant le nom produit Skills, puis le publier avec les derniers libellés du cours — tRPC et synthèse publique confirmés après `3d4a043a`
- [x] Corriger Associate Foundations cours 7 « Troubleshooting & Optimization » : durée officielle 30 min, sept écrans, diagnostics contrastés (prompt, contexte, modèle, outil, format, vérification et coût/latence), avec blocs standards, verrouillage séquentiel, test ciblé, validation groupée et contrôle public final — checkpoint `8dcdd753`, 800 tests, QA 9/9, tRPC `no-store`, liste de signaux et quiz public contrôlés
- [x] Normaliser la pseudo-table « Signal / Répétition / Correction / Variabilité » de l’écran Optimiser les flux de travail Associate 7 en liste Markdown standard, sans modifier les notions ni les FlipCards — liste Claude Sonnet contrôlée publiquement, sans dièses littéraux ; FlipCards et verrou de navigation préservés
- [x] Corriger Associate Foundations cours 8 « Exam Preparation & Next Steps » : durée officielle, écrans de synthèse, préparation d’examen, activités standard et contenu de fin de parcours ; lot Claude Sonnet publié (`25d03572`, `a0f6c579`), 803 tests, QA 9/9, tRPC `no-store`, synthèse, checkpoint et fin publics vérifiés
- [x] Corriger les libellés français redondants « et les/des prochaines étapes » des chapitres Associate 8 en « et prochaines étapes », sans modifier la hiérarchie ou le verrou — chapitres publics 2/5 et 3/5 contrôlés
- [x] Normaliser le titre visible de synthèse Associate 8 et les reliquats de terminologie des FlipCards (`workflows`, `workflow`, `Delegation`, `projets`) sans modifier les cartes ni les notions Anthropic — synthèse et cartes publiques vérifiées avec « flux de travail », « Délégation » et `Projects`
- [x] Localiser « Governance » en « Gouvernance » dans le checkpoint de readiness français Associate 8, sans modifier la logique de réponse correcte — tRPC, affichage public et réponse correcte unique `b` validés
- [x] Corriger Developer Foundations cours 1 « MSO Foundations » : durée officielle 57 min, 10 écrans alignés sur 6 sections Skilljar, définition canonique de MSO, 6 activités standards, métadonnées médias et verrouillage séquentiel — checkpoint `fa5db915`, 806 tests, QA 9/9, tRPC `no-store`, introduction, checkpoint, quiz, scénario, ressources et fin publics contrôlés
- [x] Restaurer les deux troncatures Developer 1, localiser les reliquats français, remplacer les cinq exercices libres concaténés par cinq checkpoints standard Claude Sonnet, retirer les vidéos génériques hors source et conserver dix écrans avec des ressources de référence sobres — contenu, cinq checkpoints et pages de ressources/fin vérifiés sur le domaine public
- [x] Supprimer le sommaire de sous-titres doublé et le reliquat « The fenêtre de contexte » détectés dans l’écran Comment les LLMs se comportent Developer 1, sans modifier son checkpoint standard — structure et texte public validés ; le checkpoint est toujours verrouillé avant réponse
- [x] Recalculer le total de vidéos du parcours Developer Foundations après le retrait des recommandations génériques Developer 1 afin de préserver les métriques catalogue cohérentes — le test de cohérence de parcours est vert dans les 806 tests
- [x] Corriger Developer Foundations cours 2 « Production-Grade Prompting, Agents & Tool Use » : durée officielle 209 min, 12 écrans, checkpoints agent loop/tool use, blocs standards et verrouillage séquentiel ; les laboratoires non sourcés/réellement non exécutables ne sont pas proposés — checkpoints `f757ca3a`, `298df2a5` et `3a9e67e`, 811 tests, QA 9/9 et tRPC public contrôlé
- [x] Corriger le lot critique Developer 2 : durée officielle et introduction, huit exercices racine `free_text` non standards/mal rattachés, contradictions Extended Thinking/streaming, pseudo-tableaux, titres concaténés, troncatures de cartes, reliquats anglais et huit vidéos sans provenance — huit checkpoints standards, contenu Markdown, cartes restaurées et ressources sans vidéo générique publiés
- [x] Convertir les pseudo-tableaux restants de l’écran Prompting Craft Developer 2 en sections Markdown lisibles, y compris les en-têtes concaténés `System Prompts / XML Tags / Few-shot Examples / Output Constraints`, et localiser les occurrences génériques restantes de `output constraint`, `system prompt` et `Few-shot examples` — structure et terminologie françaises contrôlées par contrat et tRPC public
- [x] Vérifier le doublon apparent de message utilisateur dans Prompting Craft Developer 2 et normaliser les derniers termes techniques génériques — les messages répétés appartiennent aux démonstrations distinctes avant/après ; les termes génériques sont localisés dans le correctif réexécutable
- [x] Corriger le reliquat générique « system prompt » de l’option de checkpoint Prompting Craft Developer 2, puis rejouer le rendu public ciblé — normalisation récursive testée sur toutes les variantes françaises ; tRPC public sans reliquat après `3a9e67e`
- [x] Exécuter un balayage Anthropic accéléré sur les cours restants : inventorier par analyse statique les troncatures, activités racine non standard, durées incohérentes, reliquats français manifestes, pseudo-tableaux et repli média sans provenance ; appliquer seulement les correctifs réexécutables déterministes puis publier une validation transversale unique — 14 cours inventoriés, 121 normalisations, TypeScript et QA 9/9 ; échantillon tRPC public 3/3 validé
- [x] Appliquer la règle 80/20 au balayage Anthropic : traiter d’abord les défauts visibles ou bloquants récurrents et reporter les micro-ajustements non fonctionnels après la fenêtre de stabilisation — normalisation transversale limitée aux reliquats visibles et récurrents ; données pédagogiques non prouvées laissées au cycle cours par cours
- [x] Normaliser de manière déterministe les reliquats génériques anglais répétés dans les variantes françaises des cours Anthropic non clôturés (`system prompt`, `workflow`, `Watch Out`, `What good looks like`, `few-shot examples`, `output constraints`) sans modifier les noms produits Anthropic ni les extraits de code — 121 substitutions sur 14 cours, contrat transversal et publication validés
- [x] Étendre la normalisation 80/20 aux reliquats français génériques fréquents (`best practices`, `key takeaways`, `human-in-the-loop`, `guardrail`, `rollout plan`, `model card`) sans traduire les noms produits Anthropic ni les identifiants techniques ; 197 occurrences conservées après revue Claude Sonnet car intentionnelles, techniques ou ambiguës, 2 corrections littérales validées et testées
- [x] Remplacer en priorité les exercices racine `free_text` invisibles ou non obligatoires des cours Anthropic restants par un checkpoint standard à choix unique, généré par Claude Sonnet à partir des notions du cours et rattaché au premier écran pédagogique pertinent ; audit complet : aucun exercice obligatoire n’est non référencé, donc aucun remplacement spéculatif n’est requis
- [x] Demander à Claude Sonnet de sélectionner au plus un exercice racine existant par cours Anthropic non clôturé lorsque son rattachement est explicite, puis l’afficher comme checkpoint standard obligatoire sans transformer les exercices ambigus ; les candidats requis sont déjà explicitement reliés, les 171 exercices facultatifs non référencés restent hors parcours
- [x] Rendre obligatoire le checkpoint Rewind du cours Architect Foundations 4, seul exercice racine supplémentaire dont le rattachement est validé par Claude Sonnet ; exercice requis, présent une seule fois dans l’écran Rewind source et protégé par contrat
- [x] Corriger Developer Foundations cours 3 « Claude Code, MCP et Intégration » par lot 80/20 : durée 142 min, durée d’introduction, métadonnées de cartes, ressources sans vidéo générique, cartes critiques, checkpoints Modes d’autorisation et de portabilité avec validation serveur, chapitres MCP / enterprise / synthèse, checkpoints S07/S14/S17 et tâches cumulatives S18/S19 Skilljar sont publiés ; aucun exercice racine résiduel n’est retenu par la sélection Claude Sonnet confrontée aux écrans Skilljar
...
- [x] Comparer les derniers TP, activités racine et l’étude de cas Developer 3 à 5 avec les écrans Skilljar accessibles dans la session authentifiée, puis ne corriger que les écarts explicitement vérifiés — tâches cumulatives, checkpoints et activités racine qualifiés source par source
- [x] Restaurer le checkpoint Skilljar Developer 5 S07B (deux choix uniques requis) et aligner S07D sur le bloc standard d’association, sans conserver de tri Neopolis non sourcé — tRPC public des deux domaines confirme les trois blocs sans clé ni explication divulguée
...
- [x] Rendre les champs pédagogiques du bloc standard `CloudExerciseBlock` bilingues sans régression des TP existants
- [x] Réintégrer les quatre tâches cumulatives source Skilljar des cours Developer 4 et 5 avec le bloc standard de réponse libre et révélation après validation
- [x] Réintégrer les chapitres Developer 3 source MCP Servers, Enterprise Integration et Key Takeaways uniquement à partir des écrans Skilljar authentifiés relevés — S12/S13, S15/S16 et S20 réconciliés avec contenu et cartes standards, sans laboratoire externe
- [x] Conserver les tâches cumulatives source S18/S19 Developer 3 ouvertes tant que leur interaction de réponse libre avec révélation ne peut pas être reproduite par un bloc standard — condition levée : séquence standard avec révélation et réflexion maintenant disponible
- [x] Ajouter une auto-évaluation post-révélation configurable au bloc standard `CloudExerciseBlock` afin de reproduire les résultats de réflexion des tâches cumulatives Skilljar
- [x] Restaurer les tâches cumulatives Skilljar Developer 3 S18 et S19 avec réponse libre, correction révélée et auto-évaluation standard
- [x] Ajouter la durée officielle Skilljar de 142 minutes au cours Developer 3, en distinguant cette valeur de toute estimation Neopolis — donnée et catalogue synchronisés, contrat ciblé vert et tRPC public confirmé
- [x] Corriger Developer Foundations cours 4 « Model Context Protocol & Architecture » par lot 80/20 : checkpoints, durée 211 min, troncatures, traductions hybrides, tableaux critiques, deux tâches cumulatives Skilljar et médias sans provenance sont publiés ou retirés ; aucun exercice racine n’est justifiable après sélection Claude Sonnet contre Skilljar et les termes techniques ambigus sont conservés
- [x] Corriger Developer Foundations cours 5 « Deployment, Accelerators & IP Contribution » par lot 80/20 : checkpoint Packaging, durée 155 min, quatre tableaux concaténés, cartes tronquées, localisations françaises ciblées, deux tâches cumulatives Skilljar, checkpoints S07B/S07D et retrait des médias sans provenance sont publiés ; l’exercice racine pertinent est remplacé, les autres ne sont pas retenus par la sélection source
- [x] Restaurer les cartes tronquées Developer 5 des écrans Packaging, Contribution, Cycle de vie et Frontières de confiance, et localiser le cycle de vie FR hybride sans créer de nouvelle activité — lot Claude Sonnet publié sous `3f1ef686`, contrat ciblé vert et cycle 1–7 confirmé par tRPC public
- [x] Ajouter les durées officielles Skilljar vérifiées : 211 minutes pour Developer 4 et 155 minutes pour Developer 5, dans les données de cours et le catalogue — contrat dédié et tRPC public confirmés après `adaebbaa`
- [x] Réparer le checkpoint Packaging Developer 5 qui vise le mauvais exercice et retirer le checkpoint Developer 5 non résoluble de l’écran Frontières de confiance, sans créer d’activité spéculative — tRPC public : seul Packaging, chapitre 2, exercice `__05_002`, est désormais exposé
- [x] Corriger le lot critique Developer 4 : les associations de checkpoints, l’activité de gestion des erreurs, les cartes critiques, la durée d’introduction, les quatre tableaux concaténés, onze localisations françaises ciblées, les tâches cumulatives et le retrait des médias sans provenance sont publiés et couverts par contrat ; les activités racine non justifiables sont écartées par sélection source, tandis que les termes techniques ambigus sont conservés
- [x] Reporter les corrections cours par cours Architect Foundations et Architect Professional à une session ultérieure ; ne traiter pendant la présente fenêtre que Developer Foundations — périmètre et éléments reportés documentés dans `docs/developer-foundations-8020-status.md`
- [x] Sélectionner avec Claude Sonnet les checkpoints texte libre Developer 3 dont le rattachement à leur écran est non ambigu, puis les rendre visibles et obligatoires au moyen des blocs standards existants — un seul checkpoint retenu sur Modes d’autorisation, publié sous `0cb0848a` et vérifié publiquement (`required`, bloc de checkpoint, 15 mots)
- [x] Retirer par lot les pages de tutoriels vidéo Anthropic dont les blocs ne portent aucune provenance vérifiable, en les remplaçant par une orientation standard vers les notions et la documentation officielle — 13 cours normalisés, contrat transversal réussi et échantillon public Architect Foundations 2 / Architect Professional 3 à 0 bloc vidéo
...
- [x] Monter TekTek avec la leçon actuellement affichée lorsqu’une URL de cours n’a pas de paramètre `lesson`, afin que l’action du centre d’assistance ouvre réellement le coach dans une session apprenant publiée — URL canonique publiée contrôlée, coach ouvert dans la session apprenant
- [x] Corriger la recherche TekTek lorsqu’une notion explicitement présente dans le cours, telle que le Framework 4D, reçoit encore un refus insuffisamment sourcé malgré des transcriptions et leçons disponibles — identifiants courts alphanumériques indexés ; réponse 4D citée validée en prévisualisation
- [x] Tester TekTek sur le domaine public avec un compte apprenant depuis l’URL canonique du cours sans paramètre `lesson`, confirmer l’ouverture via le centre d’assistance et archiver la preuve dans `docs/support-feedback-sentry.md` — réponse Framework 4D sourcée et lisible validée après publication
- [x] Après propagation publique, vérifier qu’une question TekTek depuis cette URL sans `lesson` répond avec le bon contexte de leçon affiché, sans erreur console — console publique sans erreur durant le contrôle apprenant
...
- [x] Créer l’événement Sentry associé côté serveur avant le User Feedback afin qu’il soit visible dans l’inbox on-premise, sans dépendre du transport navigateur — contrôle prévisualisation puis API : feedback visible avec référence, événement associé résolvable en HTTP 200
- [x] Tester les deux parcours d’assistance avec rôles apprenant et administrateur, puis publier et vérifier le domaine public — contrôle complet publié, console sans erreur et traçabilité Sentry API confirmée
- [x] Tester complètement le centre d’assistance avec un compte apprenant sur la version publiée : ouvrir TekTek, poser une question, ouvrir le signalement technique et vérifier le retour sans erreur — réponse 4D citée, confirmation UI et événement Sentry associé résolvable
- [x] Tester complètement le centre d’assistance avec un compte administrateur sur la version publiée : ouvrir TekTek, contrôler les sources, ouvrir le signalement et vérifier l’absence d’erreur bloquante — sources ouvrables et formulaire contrôlés sans deuxième feedback
- [x] Archiver dans `docs/support-feedback-sentry.md` les preuves distinctes apprenant/admin après publication : URL, résultat TekTek, état du signalement et contrôle de console — traçabilité ajoutée sans données sensibles
...
- [x] Auditer les thèmes, catégories, sous-catégories, métiers et formations afin de construire des grands domaines fondés sur les données réelles — inventaire reproductible de 115 formations et 177 cours, catégories et sous-catégories analysées dans `scripts/audit-professional-domains.mjs`
...
- [x] Comparer le rapport SEOptimer actualisé aux améliorations déployées, corriger les écarts applicatifs restants et qualifier les dépendances externes — audit C et recommandations applicatives qualifiés ; validation publique consignée, tandis que DNS, profils et délais des moteurs restent des dépendances externes
...
- [x] Ajouter un H2 de secours dans le HTML `noscript` afin que les robots sans JavaScript reçoivent aussi une hiérarchie H1/H2 complète sur chaque page publique React — couverture présente dans les contenus de secours et vérifiée par la suite SEO
...
- [x] Publier puis vérifier GA4, Search Console, le sitemap et les routes publiques sur le domaine de production — balise Search Console confirmée et propriété validée par le propriétaire ; sitemap et routes publics contrôlés en HTTP ; consentement et chargement GA4 revérifiés après correction CSP
...
- [x] Vérifier la requête de collecte GA4 après consentement, la réponse HTTP et les signaux de blocage navigateur sans collecter ni afficher de donnée personnelle — destination active, `/g/collect` observé, réponse Google 2xx, zéro erreur CSP et zéro échec réseau inattendu
...
- [x] Corriger, publier et documenter uniquement une anomalie applicative confirmée ; sinon fournir les étapes de validation côté propriété Analytics — bootstrap classique publié, sonde et diagnostic documentés, 5 utilisateurs actifs visibles dans les 30 dernières minutes
- [x] Autoriser explicitement l’hôte gtag dans `connect-src`, avec les seuls endpoints Analytics requis, puis vérifier que le runtime de collecte s’initialise après consentement — CSP alignée sur les familles officielles, script HTTP 200 et runtime chargé sans violation CSP
- [x] Préserver le pointeur dynamique vers `window.dataLayer` après chargement de gtag afin que les événements postérieurs à l’initialisation soient traités par le runtime Google — résolution dynamique et test de régression publiés
- [x] Émettre la mise à jour de consentement après l’initialisation effective de gtag afin que le runtime interprète la transition accordée dans l’ordre documenté — transition `granted` observée dans la file après clic
...
- [x] Comparer le maintien du consentement explicite au Consent Mode avancé sans stockage avant accord, sans activer de publicité ni transmettre de PII — décision révisée à la demande du propriétaire : charger la balise avec `analytics_storage: denied` et n’accorder le stockage qu’après choix explicite
- [x] Appliquer, tester et publier uniquement la stratégie retenue après preuve technique et consigner la validation dans GA4 — Consent Mode avancé publié, 581 tests réussis, bandeau Chrome privé validé et réception Temps réel confirmée
- [x] Corriger le chemin où `window.gtag` existe déjà afin que le clic d’acceptation émette toujours la transition `analytics_storage: granted` — correctif ciblé couvert par un test dynamique et publié
...
- [x] Reproduire sur Chromium non authentifié avec un profil temporaire vierge, capturer l’état du stockage, la visibilité du bandeau et les erreurs console sans intervention utilisateur — zéro cookie, consentement vide, bandeau visible dans le viewport, aucune erreur console ou réseau
...
- [x] Collecter les crashs récents du monitoring interne et des journaux de production sans consigner de donnée personnelle — 91 enregistrements agrégés en 7 signatures, avec routes sans paramètres, familles de navigateur et piles minimisées
- [x] Dédupliquer et classer chaque signature entre incident de déploiement, erreur ancienne et bug applicatif encore reproductible — 78 faux incidents de test, 3 anciens chunks Lazy, 1 Worker blob externe, 8 erreurs AdminTraining déjà corrigées et 1 mutation DOM récente sur `/apply`
...
- [x] Exécuter la suite complète et vérifier les parcours affectés dans un navigateur isolé — candidature rejouée en desktop/mobile avec changements répétés des deux Select, zéro ErrorBoundary, zéro pageerror et zéro ressource applicative en échec ; 595 tests réussis et matrice 9/9
- [x] Publier puis confirmer sur le domaine public la disparition des crashs reproductibles et documenter les incidents seulement qualifiés — candidature rejouée en desktop/mobile sans crash ; monitoring réduit à deux signatures historiques datées d’avant leurs correctifs, sans nouvelle occurrence
...
- [x] Publier puis confirmer l’état des issues Sentry et documenter les incidents anciens ou externes — correctifs propagés, `/login` rendu sans erreur Lazy et relecture des 11 groupes sans nouvelle occurrence ; statuts Sentry laissés inchangés volontairement
...
- [x] Mettre à niveau les dépendances de production vulnérables avec des versions corrigées, une vérification des chaînes transitives et des tests de non-régression — `mysql2` et Tiptap mis à jour ; overrides Express/body-parser vers `qs 6.16.0`, patch Wouter conservé ; audit pnpm production à 0 vulnérabilité
- [x] Remplacer les requêtes administratives N+1 relevées dans les services d’intégrité et d’orientation par des lectures groupées paginées, sans modifier les contrats de l’interface — intégrité : cinq lectures constantes ; orientation : profils, définitions, contributions et propositions regroupés, avec indexation locale par compétence et contrats représentatifs
- [x] Retirer ou adapter les références apprenant résiduelles à DataLab et les libellés XP externes, en conservant les activités, ressources et règles de compétences Neopolis — dix cours normalisés, 2 visuels source retirés, 6 compteurs `LocalEnvironmentExercise`, 47 champs XP externes supprimés et test d’hygiène ajouté
- [x] Exécuter les validations de contenu, les tests complets et la matrice QA avant publication — validation JSON/cours sans erreur bloquante, 611 tests réussis (2 ignorés), TypeScript, diff-check et matrice QA 9/9 réussis ; les avertissements de proximité de choix déjà connus restent non bloquants
- [x] Créer le checkpoint auto-publié, attendre la propagation et vérifier sur le domaine public les dépendances, les écrans administratifs et les parcours représentatifs sans exposer de données personnelles — publication réussie `6be17752` après alignement pnpm ; contrôle du lecteur et 10/10 JSON assainis, sonde admin authentifiée et compteurs/progression publiés validés
- [x] Corriger les soumissions Search Console historiques de `/static.xml` et `/formations-*.xml` en leur servant les XML compatibles correspondants, puis vérifier l’index et tous les chemins avec les profils Googlebot — publication `d8f79ef0` contrôlée : XML HTTP 200 pour index, chemins canoniques et historiques ; 909 URLs publiques validées
- [x] Auditer l’attribution non attendue d’un rôle admin-apprenant, restaurer le rôle apprenant du compte concerné et réserver la gestion des rôles au super-administrateur avec journalisation et commande UI visible — compte restauré en `user`, aucune trace historique disponible ; publication `c27265c3`, 612 tests, QA 9/9 et contrôle administrateur authentifié validés
- [x] Auditer les signaux d’intégrité pédagogique puis implémenter un contrôle unique, gradué et réversible contre les parcours automatisés, avec vérification explicable et revue administrative avant blocage définitif — Learning Integrity Gate publié : vérification Turnstile validée côté serveur, migration 0042 appliquée, CSP contrôlée, 616 tests et QA 9/9 ; parcours apprenant publié accessible hors signal de risque
- [x] Ajouter un honeypot accessible aux formulaires d’examen et traiter son remplissage comme un signal fort du Learning Integrity Gate, sans sanction définitive automatique ni impact sur les apprenants légitimes — publication `cf51dc50` vérifiée : formulaire normal intact, leurre absent du rendu humain, serveur ne conserve aucune valeur et suspend temporairement les soumissions déclenchées
- [x] Auditer les crashs et signaux de monitoring récents, corriger les causes reproductibles et ajouter des protections préventives validées sur les parcours concernés — import Lazy d’overlays corrigé, récupération nommée généralisée, publication `0461884e` propagée ; onglet Parrainage contrôlé sans ErrorBoundary ni erreur console, 620 tests et QA 9/9
...
## Gestion des identifiants apprenant
- [x] Auditer le fournisseur d’authentification existant et les profils apprenant/admin afin de préserver les parcours de connexion et invitations — sessions JWT applicatives, OAuth, comptes e-mail, invitations, réinitialisations et dossier apprenant analysés
...
- [x] Publier puis vérifier le chemin et les surfaces publiques associées — révision publique `7a92e839009aeebd` contrôlée ; le fragment `AdminContentManager-BJkexJC-.js` sert les commandes « Images de formation », « Gérer les visuels » et « Carte catalogue et en-tête (4:3) » ; le catalogue public reste accessible

## Administration — communications
- [x] Auditer la liste, les données et les actions des communiqués afin d’identifier les erreurs de navigation, statut, destinataires et dates — lignes non ouvrables, date en cinquième colonne, absence de recherche/pagination exploitée malgré le support serveur, types non localisés et fenêtre apprenant importante bloquant l’admin identifiés
- [x] Rendre chaque communiqué ouvrable avec une vue détaillée et placer la date comme première colonne de la liste — ligne, sujet et action « Voir » ouvrent une fiche avec contenu, ciblage, statut, date de création/programmation/envoi et actions compatibles
- [x] Ajouter ou corriger les contrôles de recherche, pagination, droits et actions de gestion pour une liste administrable fiable — recherche serveur, filtre de statut, plage de création, pagination, statuts/types français et tests de droit/validation ajoutés
- [x] Empêcher les fenêtres de communiqué apprenant importantes de bloquer l’espace d’administration — requête et accusé de réception désactivés seulement sur `/admin` et sous-routes, helper couvert par tests
- [x] Tester le parcours détail, les actions et le rendu responsive, puis publier et vérifier la page Communications — détail ouvert sans modification, recherche « parrainage » et droits testés, mobile 390×844 lisible sans fenêtre apprenant ; révision publique `a42e78139486e6df` et fragment `AdminDashboard-B8MLnvUq.js` contrôlés avec les marqueurs de recherche, date et fiche détail

## Évaluation — classement et revue d’intégrité
- [x] Auditer les critères et départages du classement Top apprenants, ainsi que les signaux d’intégrité réellement disponibles par apprenant — tri historique uniquement par leçons terminées ; les entrées `training_progress` correspondent bien à des leçons ; les signaux existants reposent sur validations rapprochées, temps déclaré, soumissions répétées et absence de vidéo
- [x] Définir un indicateur « À vérifier » transparent, proportionné et réservé aux administrateurs, sans qualifier automatiquement une fraude — file de revue existante réutilisée dès un score de 20/100 ou une revue humaine ; message explicite de non-preuve/non-sanction, statut « Écarté après revue » conservé
...
- [x] Tester le rendu net du logo sur desktop et mobile, puis publier et vérifier en production — rendu PNG désormais vérifié directement dans le DOM de l’accueil publié ; source `/api/assets/neopolis-akademy-header-120x42-rendered_e0ac12ce.png` active dans l’en-tête
...
- [x] Définir le modèle WebSocket persistant, les données, les droits, la confidentialité, le cycle de vie et la stratégie de notifications des conversations privées — architecture détaillée dans `docs/private-messaging-architecture.md`, avec persistance avant diffusion, isolation apprenant/équipe, audit, fermeture réversible et limitation e-mail
- [x] Activer l’hébergement persistant requis par le WebSocket — option B validée par l’utilisateur et hébergement Always-On activé avant la construction du service live
- [x] Construire le socle des conversations en direct, de l’historique et des notifications — tables dédiées, migrations 0045 non destructives, isolation par apprenant, routes tRPC protégées, messages persistés avant diffusion, canal WebSocket same-origin en lecture seule et e-mails sans contenu privé ; TypeScript et tests ciblés validés
- [x] Ajouter les fenêtres flottantes par sujet, les indicateurs web en direct et l’historique visible dans les interfaces — launcher global apprenant, fenêtres par fil, badge non lu, toast discret et historique persistant vérifiés en prévisualisation
- [x] Ajouter les vues administrateur et apprenant, déplacer le signalement de problème et préparer l’automatisation responsable des alertes d’intégrité — inbox `/admin?tab=messages`, onglet apprenant, pavé 360°, signalement privé et brouillon interne non accusatoire à revue humaine
...
## Évolutions messagerie et espace apprenant — 12 septembre 2026
- [x] Ajouter une pagination serveur stable à l’inbox administrative privée, au-delà de 200 fils, sans filtrage client exhaustif — pagination SQL comptée, filtres et navigation de pages dans l’inbox
- [x] Ajouter un centre de notifications privé et des préférences par utilisateur pour les alertes web et e-mail, sans exposer le contenu des messages dans les e-mails — centre réutilisable et préférences web/e-mail/son sauvegardées par utilisateur
- [x] Ajouter une alerte sonore accessible, le défilement automatique conditionnel vers les nouveaux messages et un marqueur de lecture fiable dans les fenêtres de chat — signal local activable, défilement au dernier message et lecture au passage effectif dans le viewport
- [x] Préparer une file d’intégrité administrable, avec ciblage explicable, brouillon ferme décrivant une activité suspecte d’automatisation et de contournement de checkpoints, revue humaine et confirmation obligatoire avant toute création ou tout envoi de messages aux apprenants — file réservée aux administrateurs, revues écartées exclues, anti-doublon et confirmation obtenue avant exécution
...
- [x] Restructurer les contenus Anthropic retenus avec les blocs standards et la sémantique appropriée : titres, gras, italique, listes, étapes, tableaux et encadrés — modèles, scénarios, appariements et tableaux aplatis confirmés ont été convertis en Markdown standard dans Associate ; les cas Architect/Developer non corroborés par les données locales ont été conservés pour la revue source utilisateur, sans suppression spéculative
- [x] Remplacer les placeholders de visuels uniquement par des composants standards factuels et localiser les blocs dans la langue active sans inventer de contenu — placeholders vides et instructions UI importées supprimés sur les 28 fichiers ; scénario Associate converti en structure standard factuelle ; contenus FR de Claude 101 et Claude Code localisés sans modifier code/commandes
- [x] Vérifier la cohérence des parcours, le verrouillage séquentiel, les rendus desktop/mobile et publier après contrôle ciblé — tests de conservation, 728 tests globaux, QA publication 9/9 (y compris audit d’interactions et blocs desktop/mobile), checks TypeScript/diff et vérifications publiques des corrections Associate/Claude 101 réalisés avant publication
...
- [x] Localiser strictement les champs français encore entièrement anglais de Claude 101, Claude Code 101 et Claude Code in Action — 520 traductions validées par schéma, longueur et confiance ; commandes, chemins et exemples de code préservés ; aucun texte pédagogique non localisé ne subsiste dans ces trois cours
- [x] Comparer les cas ambigus Anthropic à Skilljar avec une session autorisée, sans télécharger ni réutiliser un média non autorisé et sans écraser les enrichissements Neopolis — étape explicitement contournée sur instruction utilisateur après réponse CloudFront 403 persistante
- [x] Revue source Skilljar après publication en production par l’utilisateur — transfertée à l’utilisateur comme convenu ; aucune donnée source ni média protégé n’est récupéré par la plateforme
- [x] Ajouter une correction pédagogique bilingue au scénario standard « Reconcevoir un workflow » du cours Associate 4 afin qu’une soumission réussie explique les arbitrages Automatiser / Humain / Collaboratif — correction française et anglaise publiée ; score 5/5, feedback détaillé et navigation post-activité rejoués publiquement
- [x] Reconcevoir les banques de questions des examens blancs Anthropic à partir de l’échantillon fourni : conserver les exemples autorisés par l’utilisateur, générer exclusivement avec Claude Sonnet des questions originales de difficulté et de format comparables, puis préserver la correction côté serveur et les règles d’examen existantes
- [x] Reprendre l’audit des formations Architect Foundations : réconcilier les écarts encore ouverts par cours avec les sources disponibles, corriger les données et blocs standards nécessaires, puis valider les parcours sans modifier les banques d’examens Anthropic déjà publiées ; différences de comptage non nominatives documentées sans correction spéculative
- [x] Corriger le rattachement du checkpoint Rewind dans Architect Foundations cours 4 : conserver son activité obligatoire uniquement dans l’écran Rewind source et retirer le doublon hors contexte de l’exercice Plugins
- [x] Réconcilier les frontières de modules du cours Architect Foundations « Claude with Amazon Bedrock » : vérifier la place de l’introduction, des exercices, des synthèses et des deux écrans Module Complete à partir d’une source de séquencement, sans inventer de contenu ni casser le verrouillage ; ordre conservé car l’introduction est celle du module 06 et les autres déplacements ne sont pas sourcés
...
- [x] Vérifier et régénérer l’index de recherche des formations après les dernières corrections : 177 cours et 3 528 chapitres indexés, sans entrée manquante, doublon, fichier orphelin ni lien invalide
- [x] Diagnostiquer l’absence d’indexation Google du domaine public : audit Googlebot confirme robots autorisant l’exploration, HTML public canonique/indexable et XML valide ; la directive HTTP `X-Robots-Tag: noindex` sur l’index et les lots de sitemap constituait le signal contradictoire ; `sitemap-index.xml` fournit désormais une URL canonique fraîche, `robots.txt` la déclare, les URL historiques restent compatibles et les contrats Googlebot ainsi que la QA de publication sont validés

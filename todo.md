...
- [ ] Republier puis vérifier la boîte de réception après le correctif mobile de l’en-tête — recherche « orientation » validée (2 à 1 communiqué), lecture persistante confirmée par l’API, état important non accusé couvert par test, sonde mobile locale sans débordement et QA 6/6 réussie

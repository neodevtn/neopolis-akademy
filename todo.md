...
- [ ] Diagnostiquer et corriger l’alerte ErrorBoundary `DeferredAuthenticatedOverlays` sur l’onglet Parrainage, y compris les scénarios de cache de bundle obsolète, puis vérifier la production
- [ ] Vérifier et rétablir la notification de nouvelle version afin que les sessions ouvertes détectent une publication et proposent un rafraîchissement sans interrompre l’apprentissage

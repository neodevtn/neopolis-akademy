...
- [ ] Corriger Associate Foundations cours 4 : afficher la durée officielle Skilljar de 63 minutes, auditer les 10 écrans et rendre les arbitrages humain/modèle et cas de workflow réellement interactifs
...
- [ ] Harmoniser le titre français du quiz Module 4 Associate 4 en remplaçant le reliquat non nominal « workflow » par « flux de travail », sans modifier les scénarios ni les règles du quiz
- [ ] Harmoniser les occurrences françaises non nominatives restantes de « workflow » dans les titres, contenus et corrections Associate 4 avec « flux de travail », sans modifier les noms de produits Anthropic ni les activités
- [ ] Mettre à jour le contrat de nettoyage Associate 4 afin qu’il valide les tableaux localisés « Étape du flux de travail » sans exiger le reliquat anglais supprimé
...
- [ ] Empêcher qu’un cache HTTP/CDN périmé masque un JSON de cours corrigé après publication, en versionnant la récupération standard des données sans invalider la cache mémoire de la session — réouvert : le CDN a servi une copie statique antérieure malgré `course-version`; la route tRPC remplace ce mécanisme et doit être validée publiquement
...
- [ ] Corriger la résolution du répertoire de données de cours dans le bundle serveur de production afin que la route tRPC lise bien `dist/public/data/courses` au lieu de retourner 404

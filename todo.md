...
- [ ] Réconcilier les frontières de modules du cours Architect Foundations « Claude with Amazon Bedrock » : vérifier la place de l’introduction, des exercices, des synthèses et des deux écrans Module Complete à partir d’une source de séquencement, sans inventer de contenu ni casser le verrouillage

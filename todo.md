...
- [ ] Corriger Associate Foundations cours 5 « Configuration & Knowledge Management » : durée officielle 47 min, huit écrans, Projects, instructions, knowledge base, Skills et Memory, sans exercices libres historiques ni reliquats de localisation ; publier seulement après tests, QA, propagation et contrôle public — durée, tRPC et activités validés ; la clôture reste suspendue aux corrections de mise en forme Projects/Instructions et à leur rejeu public
- [ ] Corriger les reliquats anglais et les formulations françaises dégradées constatés dans les écrans Projects et Connecteurs Associate 5, puis republier et rejouer la revue publique — Connecteurs validé ; Projects reste à corriger et contrôler
...
- [ ] Corriger les intertitres/sections mal structurés de l’écran Projects Associate 5 (« Un Project par client », « Scoped Memory… », « Lorsqu’un besoin… ») et rejouer le contrôle public
- [ ] Corriger la comparaison « Avant / Après » incohérente de l’écran Instructions Associate 5, puis vérifier publiquement le rendu
- [ ] Rejouer la revue publique finale complète des 8 écrans Associate 5 après le dernier lot de mise en forme et ne clôturer que les tâches explicitement prouvées

...
- [ ] Corriger Developer Foundations cours 4 « Model Context Protocol & Architecture » par lot 80/20 : checkpoints, durée 211 min, troncatures, traductions hybrides, tableaux critiques, deux tâches cumulatives Skilljar et médias sans provenance sont publiés ou retirés ; restent les activités racine non justifiables et les termes techniques ambigus conservés
- [ ] Corriger Developer Foundations cours 5 « Deployment, Accelerators & IP Contribution » par lot 80/20 : checkpoint Packaging, durée 155 min, quatre tableaux concaténés, cartes tronquées, localisations françaises ciblées, deux tâches cumulatives Skilljar et retrait des médias sans provenance sont publiés ; restent les activités racine ambiguës et les contenus qui exigent une source complémentaire
...
- [ ] Corriger le lot critique Developer 4 : les associations de checkpoints, l’activité de gestion des erreurs, les cartes critiques, la durée d’introduction, les quatre tableaux concaténés, onze localisations françaises ciblées et le retrait des médias sans provenance sont publiés et couverts par contrat ; restent les activités racine, tandis que les termes techniques ambigus sont conservés

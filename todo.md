...
- [x] Reproduire et corriger les bugs confirmés comme actifs ou bloquants, puis ajouter les tests de régression nécessaires — orientation, récupération de bundles et lecteur Projector corrigés ; 15 tests ciblés, QA média/orientation et 515 tests complets réussis
- [ ] Publier les correctifs puis vérifier sur le domaine public la récupération de bundle, la limite d’orientation et le repli Projector, avant d’archiver les preuves

...
- [ ] Corriger Associate Foundations cours 4 : afficher la durée officielle Skilljar de 63 minutes, auditer les 10 écrans et rendre les arbitrages humain/modèle et cas de workflow réellement interactifs — réouvert : revue publique continue 10/10 à répéter sur la version tRPC finale
...
- [ ] Harmoniser les occurrences françaises non nominatives restantes de « workflow » dans les titres, contenus et corrections Associate 4 avec « flux de travail », sans modifier les noms de produits Anthropic ni les activités — réouvert : audit de données validé, revue continue 10/10 du rendu tRPC final encore requise
...
- [ ] Vérifier exhaustivement les titres, cartes, contenus et corrections français Associate 4 après les derniers correctifs, puis archiver une preuve consolidée de l’absence de reliquat « workflow » non nominal — réouvert : refaire la revue publique continue après `d7fd6ba5`
...
- [ ] Ajouter une correction pédagogique bilingue au scénario standard « Reconcevoir un workflow » du cours Associate 4 afin qu’une soumission réussie explique les arbitrages Automatiser / Humain / Collaboratif

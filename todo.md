...
- [ ] Corriger Associate Foundations cours 7 « Troubleshooting & Optimization » : durée officielle 30 min, sept écrans, diagnostics contrastés (prompt, contexte, modèle, outil, format, vérification et coût/latence), avec blocs standards, verrouillage séquentiel, test ciblé, validation groupée et contrôle public final
- [ ] Normaliser la pseudo-table « Signal / Répétition / Correction / Variabilité » de l’écran Optimiser les flux de travail Associate 7 en liste Markdown standard, sans modifier les notions ni les FlipCards
